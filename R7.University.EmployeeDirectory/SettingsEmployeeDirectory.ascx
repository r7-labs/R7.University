...
<dnn:DnnCssInclude runat="server" FilePath="~/DesktopModules/MVC/R7.University.EmployeeDirectory/admin.css" Priority="200" />
<dnn:DnnCssInclude runat="server" FilePath="~/DesktopModules/MVC/R7.University/css/admin.css" />

...
namespace R7.University.Tests.ViewModels
{
    ...
    public class ViewModelBaseTests
    {
        ...
        public void EmployeeViewModelBaseTest ()
        {
            ...
            fixture.Customize<EduProgramInfo> (c => c.Without (ep => ep.Division).Without (ep => ep.Divisions).Without (ep => ep.EduProgramProfiles).Without (ep => ep.EduLevel));
            ...
            fixture.Customize<EduProgramProfileInfo> (c => c.Without (epp => epp.Division).Without (epp => epp.Divisions).Without (epp => epp.EduLevel));

...
<div class="dnnForm dnnClear">
	<div id="employee-tabs">
		...
		<div id="employee-common-tab" style="position:relative">
            <asp:UpdatePanel id="panelCommon" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
        			<fieldset>
		...
		<div id="employee-positions-tab">
             <asp:UpdatePanel id="panelPositions" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
    			<fieldset>
    				<div class="dnnFormItem">
		...
		<div id="employee-achievements-tab">
            <asp:UpdatePanel id="panelAchievements" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
    			<fieldset>
    				<div class="dnnFormItem">
		...
		<div id="employee-disciplines-tab">
            <asp:UpdatePanel id="panelDisciplines" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
    			<fieldset>
        ...
        <div id="employee-about-tab">
            <asp:UpdatePanel id="panelAbout" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                <fieldset>
    				<div class="dnnFormItem">

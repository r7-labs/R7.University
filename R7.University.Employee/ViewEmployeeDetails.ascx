...
<dnn:DnnCssInclude runat="server" FilePath="~/DesktopModules/MVC/R7.University/bootstrap/css/bootstrap.min.css" Name="bootstrap" Version="3.0.0" />
<dnn:DnnCssInclude runat="server" FilePath="~/DesktopModules/MVC/R7.University/bootstrap/css/bootstrap.theme.min.css" Name="bootstrap.theme" Version="3.0.0" />
<dnn:DnnJsInclude runat="server" FilePath="~/DesktopModules/MVC/R7.University/bootstrap/js/bootstrap.min.js" Name="bootstrap" Version="3.0.0" ForceProvider="DnnFormBottomProvider" />
